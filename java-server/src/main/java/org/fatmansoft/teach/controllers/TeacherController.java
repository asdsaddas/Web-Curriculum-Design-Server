...
public class TeacherController {
    ...
    public DataResponse teacherEditSave(@Valid @RequestBody DataRequest dataRequest) {
        ...
        s.setInterest(CommonMethod.getString(form, "interest"));
        s.setPublication(CommonMethod.getString(form, "publication"));
        s.setTuition(CommonMethod.getString(form, "tuition"));
